    ...
    for i in ip:
        ...
        try:
            ...
            for i in ipShop:
                ...
                Tops = Label(root, width= 1350, font=('times new roman', 40, 'bold'), text = NameShop, relief=GROOVE,fg="white", bg="#6495ED", bd=10)
                Tops.pack(side=TOP) 
                
                fCarRigis = LabelFrame(root, text='Customer Details', font=('times new roman', 12, 'bold'),fg="#000000",  width= 1350, height = 6, relief=GROOVE, bg="#FF99CC", bd=10)
                ...
                fMenu1 = LabelFrame(root, text='Menu '+ MenuType1, font=('times new roman', 12, 'bold'),fg="#000000", bd=10, bg="#A4C8F0", relief=GROOVE)
                fMenu1.place(x=0, y=180, width=490, height=400)
                fMenu2 = LabelFrame(root, text='Menu '+ MenuType2, font=('times new roman', 12, 'bold'),fg="#000000" ,bd=10, bg="#A4C8F0", relief=GROOVE)
                fMenu2.place(x=490, y=180, width=490, height=400)
                
                fReceipt = LabelFrame(root, text='Receipt', font=('times new roman', 12, 'bold'),fg="#000000",  bd=10, bg="#FFFF88", relief=GROOVE)
                fReceipt.place(x=980, y=180, width=370, height=400)
                
                fCost1 = LabelFrame(root, text='Receipt Menu', font=('times new roman', 12, 'bold'),bg="#FF99CC", fg="#000000",width= 490,height = 330, bd=10, relief=GROOVE)
                fCost1.place(x=0, y=580, width=980, height=170)
                fButton = LabelFrame(root,width= 490,height = 320, bd=10,bg="#FFFF88",relief=GROOVE)
                ...
                lblCarRigis = Label(fCarRigis, font=('times new roman', 16, 'bold'), bg="#FF99CC", text="Car registration",fg="#000000", bd=16, anchor='w')
                ...
                Product0 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[0], height=1, bg="#A4C8F0", variable = VarProductList[0],onvalue = 1, offvalue=0,
                ...
                Product1 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[1], height=1, bg="#A4C8F0", variable = VarProductList[1],onvalue = 1, offvalue=0,
                ...
                Product2 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[2], height=1, bg="#A4C8F0", variable = VarProductList[2],onvalue = 1, offvalue=0,
                ...
                Product3 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[3], height=1, bg="#A4C8F0", variable = VarProductList[3],onvalue = 1, offvalue=0,
                ...
                Product4 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[4], height=1, bg="#A4C8F0", variable = VarProductList[4],onvalue = 1, offvalue=0,
                ...
                Product5 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[5], height=1, bg="#A4C8F0", variable = VarProductList[5],onvalue = 1, offvalue=0,
                ...
                Product6 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[6], height=1, bg="#A4C8F0", variable = VarProductList[6],onvalue = 1, offvalue=0,
                ...
                Product7 = Checkbutton(fMenu1, padx=15, pady=6, text=Menu1List[7], height=1, bg="#A4C8F0", variable = VarProductList[7],onvalue = 1, offvalue=0,
                ...
                Goods0 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[0], height=1,bg="#A4C8F0", variable = VarGoodsList[0] ,onvalue = 1, offvalue=0,
                ...
                Goods1 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[1], height=1, bg="#A4C8F0", variable = VarGoodsList[1],onvalue = 1, offvalue=0,
                ...
                Goods2 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[2], height=1, bg="#A4C8F0", variable = VarGoodsList[2],onvalue = 1, offvalue=0,
                ...
                Goods3 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[3], height=1, bg="#A4C8F0", variable = VarGoodsList[3],onvalue = 1, offvalue=0,
                ...
                Goods4 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[4], height=1, bg="#A4C8F0", variable = VarGoodsList[4],onvalue = 1, offvalue=0,
                ...
                Goods5 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[5], height=1, bg="#A4C8F0", variable = VarGoodsList[5],onvalue = 1, offvalue=0,
                ...
                Goods6 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[6], height=1, bg="#A4C8F0", variable = VarGoodsList[6],onvalue = 1, offvalue=0,
                ...
                Goods7 = Checkbutton(fMenu2, padx=15, pady=6, text=Menu2List[7], height=1, bg="#A4C8F0", variable = VarGoodsList[7],onvalue = 1, offvalue=0,
                ...
                lblCostofProduct = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'), text="Cost of " + Type1,bd=8,bg="#FF99CC",fg="#000000")
                ...
                lblCostofGoods = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'),text="Cost of " + Type2,bd=8,bg="#FF99CC",fg="#000000")
                ...
                lblServiceCharge = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'),text="Service Charge",bd=8,bg="#FF99CC",fg="#000000")
                ...
                lblPaidTax = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'), text="Paid Tax",bd=8,bg="#FF99CC",fg="#000000")
                ...
                lblSubTotal = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'),text="Sub Total",bd=8,bg="#FF99CC",fg="#000000")
                ...
                lblTotalCost = Label(fCost1, padx=15, pady=3, font=('times new roman',16,'bold'),text="Total",bd=8,bg="#FF99CC",fg="#000000")
                ...
                #================================== Button =========================
                btnTotal=Button(fButton,padx=20, fg="black",bg="#A4C8F0",font=('times new roman',16,'bold'),width=9, 
                                text="Total",command=CostofItem).grid(row=0, column=0, pady=23, padx=10)
                btnReceipt=Button(fButton,padx=20, fg="black",bg="#A4C8F0",font=('times new roman',16,'bold'),width=9,
                                text="Receipt",command=Receipt).grid(row=0, column=1, padx=10, pady=10)
                btnReset=Button(fButton,padx=20, fg="black",bg="#A4C8F0",font=('times new roman',16,'bold'),width=9,
                                text="Reset",command=Reset).grid(row=1, column=0)
                btnExit=Button(fButton,padx=20, fg="black",bg="#A4C8F0",font=('times new roman',16,'bold'),width=9,
